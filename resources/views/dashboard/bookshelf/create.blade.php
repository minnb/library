...
<form class="form-horizontal" role="form" action="{{ route('post.dashboard.ks.create')}}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="form-group">
        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Mã kệ sách </label>
        <div class="col-sm-9">
            <input type="text" id="form-field-1" name="so_ke" class="col-xs-10 col-sm-5" readonly value="{{ App\Models\Bookshelf::getMaKeSach() }}" />
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Tên kệ sách </label>
        <div class="col-sm-9">
            <input type="text" id="form-field-2" name="ten_ke_sach" class="col-xs-10 col-sm-5" required value="{{ old('ten_ke_sach')}}" />
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group ">
        ...
        <div class="col-xs-3">
            <input type="number" id="spinner1" name="chieu_rong" value="{{old('chieu_rong')}}" placeholder="0" style="text-align: right;"/>
       ...
       <div class="col-xs-3">
            <input type="number" id="spinner1" name="chieu_cao" value="{{old('chieu_cao')}}" placeholder="0" style="text-align: right;"/>
            <div class="space-6"></div>
       </div>
    </div>
    ...
    <div class="form-group ">
        ...
        <div class="col-xs-3">
            <input type="number" id="spinner1" name="chieu_dai" value="{{old('chieu_dai')}}" placeholder="0" style="text-align: right;"/>
            <div class="space-6"></div>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-9">
            <textarea name="thong_tin_khac" id="thong_tin_khac" rows="6" class="col-xs-9 col-sm-5">{{ old('thong_tin_khac')}}</textarea>
        </div>
    </div>
    <div class="form-group">
