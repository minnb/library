...
<form class="form-horizontal" role="form" action="{{ route('post.dashboard.cate.book.nxb.create')}}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="form-group">
        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Tên nhà xuất bản </label>
        <div class="col-sm-9">
            <input type="text" id="form-field-1" name="ten_nxb" class="col-xs-10 col-sm-5" required="" value="{{ old('ten_nxb')}}" />
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Tên đầy đủ </label>
        <div class="col-sm-9">
            <input type="text" id="form-field-1" name="ten_nxb_2" class="col-xs-10 col-sm-5"  value="{{ old('ten_nxb_2')}}" />
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Số điện thoại</label>
        <div class="col-sm-9">
            <input type="text" id="form-field-1" name="dien_thoai" class="col-xs-10 col-sm-5"  value="{{ old('dien_thoai')}}" />
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Địa chỉ</label>
        <div class="col-sm-9">
            <input type="text" id="form-field-1" name="dia_chi" class="col-xs-10 col-sm-5"  value="{{ old('dia_chi')}}" />
        </div>
    </div>
    <div class="form-group">
